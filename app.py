...
# ---------- File uploader ----------
uploaded = st.file_uploader("Upload a car image (JPG / PNG)", type=["jpg", "jpeg", "png"])
...
if uploaded is not None:
    ...
    if len(boxes_np):
        ...
        st.warning("No plates detected above the confidence threshold. Try lowering it.")
else:
    st.info("👆 Upload an image to get started.")
    st.markdown(
        "**Tip:** lower the confidence threshold in the sidebar if the detector misses the plate, "
        "or raise it to suppress spurious boxes."
    )
